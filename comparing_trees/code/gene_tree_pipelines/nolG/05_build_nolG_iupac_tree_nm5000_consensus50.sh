...
# nolG: build mixed-IUPAC all-pass IQ-TREE with ModelFinder, UFBoot, SH-aLRT, nm5000.
...
GENE="nolG"
ALIGN="${OUT}/gene_trees/nolG/02_alignment/nolG_consensus50_iupac_all_pass.mafft.fasta"
TREE_DIR="${OUT}/gene_trees/nolG/04_tree_iupac_nm5000"
PREFIX="$TREE_DIR/nolG_consensus50_iupac_all_pass_nm5000"
FORCE="${FORCE:-0}"
mkdir -p "$TREE_DIR"
