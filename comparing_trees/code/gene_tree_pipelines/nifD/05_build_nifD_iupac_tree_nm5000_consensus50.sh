...
# nifD: build mixed-IUPAC all-pass IQ-TREE with ModelFinder, UFBoot, SH-aLRT, nm5000.
...
GENE="nifD"
ALIGN="${OUT}/gene_trees/nifD/02_alignment/nifD_consensus50_iupac_all_pass.mafft.fasta"
TREE_DIR="${OUT}/gene_trees/nifD/04_tree_iupac_nm5000"
PREFIX="$TREE_DIR/nifD_consensus50_iupac_all_pass_nm5000"
FORCE="${FORCE:-0}"
mkdir -p "$TREE_DIR"
