...
# nifK: build mixed-IUPAC all-pass IQ-TREE with ModelFinder, UFBoot, SH-aLRT, nm5000.
...
GENE="nifK"
ALIGN="${OUT}/gene_trees/nifK/02_alignment/nifK_consensus50_iupac_all_pass.mafft.fasta"
TREE_DIR="${OUT}/gene_trees/nifK/04_tree_iupac_nm5000"
PREFIX="$TREE_DIR/nifK_consensus50_iupac_all_pass_nm5000"
FORCE="${FORCE:-0}"
mkdir -p "$TREE_DIR"
