...
# nifK: build strict single-dominant IQ-TREE with ModelFinder, UFBoot, SH-aLRT, nm5000.
...
GENE="nifK"
ALIGN="${OUT}/gene_trees/nifK/02_alignment/nifK_consensus50_strict_single_dominant.mafft.fasta"
TREE_DIR="${OUT}/gene_trees/nifK/03_tree_strict_nm5000"
PREFIX="$TREE_DIR/nifK_consensus50_strict_single_dominant_nm5000"
FORCE="${FORCE:-0}"
mkdir -p "$TREE_DIR"
