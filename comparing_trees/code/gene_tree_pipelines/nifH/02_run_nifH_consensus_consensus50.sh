...
# nifH: extract strict and mixed-IUPAC consensus sequences from good-coverage BAMs.
# Good coverage is selected from consensus50_gene_coverage_all_samples.tsv:
#   gene == nifH, percent_covered >= 80, mean_depth >= 10.
...
PYTHON_SCRIPT="$SCRIPT_DIR/01_extract_nifH_consensus_consensus50.py"
...
QC_TABLE="$RUN_DIR/nifH_consensus_qc.tsv"
SELECTED="$RUN_DIR/nifH_selected_samples.tsv"
...
echo "nifH: selected samples: $N"
echo "nifH: output: $RUN_DIR"
