...
# nifH: build mixed-IUPAC all-pass IQ-TREE with ModelFinder, UFBoot, SH-aLRT, nm5000.
...
GENE="nifH"
ALIGN="${OUT}/gene_trees/nifH/02_alignment/nifH_consensus50_iupac_all_pass.mafft.fasta"
TREE_DIR="${OUT}/gene_trees/nifH/04_tree_iupac_nm5000"
