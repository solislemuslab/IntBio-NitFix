...
# nodX: build strict single-dominant IQ-TREE with ModelFinder, UFBoot, SH-aLRT, nm5000.
...
GENE="nodX"
ALIGN="${OUT}/gene_trees/nodX/02_alignment/nodX_consensus50_strict_single_dominant.mafft.fasta"
TREE_DIR="${OUT}/gene_trees/nodX/03_tree_strict_nm5000"
PREFIX="$TREE_DIR/nodX_consensus50_strict_single_dominant_nm5000"
FORCE="${FORCE:-0}"
mkdir -p "$TREE_DIR"
