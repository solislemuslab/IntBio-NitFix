...
ALIGNMENT="${ALIGNMENT:-$ALIGNDIR/nifH_consensus50_strict_single_dominant.mafft.fasta}"
PREFIX="${PREFIX:-$TREEDIR/nifH_consensus50_strict_single_dominant}"
...
echo "Step 14 V2 consensus50: build strict nifH tree with IQ-TREE"
